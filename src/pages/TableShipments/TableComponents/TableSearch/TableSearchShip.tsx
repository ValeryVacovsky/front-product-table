...
const TableSearchShip: React.FC<ITableSearchProps> = ({ column, setRowDataLoading, tableSettings, tableSettingsLoaded, setTableSettingsToEqualCheck }) => {
    ...
    return (
        <div className="flex flex-col justify-between relative">
            <div className="mb-1">
                <Input value={value} changeHandler={changeHandler} name="tableFilter" placeholder="" customClassName="max-w-[90%]" />
            </div>
        </div>
    )
}

export default TableSearchShip;